...
<br><br>
   ...
   <section>
      ...
      <table>
         <tr>
            <th>Product Name</th>
            <th>Product Price in &dollar;</th>
            <th>Click against this column to add</th>
         </tr>
         ...
         ?>
            <tr>
               <form action="product.php" method="get">
                  ...
                  <td><input type="submit" name="submit" value="Here" class="form-btn" style="border-radius: 4px; border-color: white;"></td>
