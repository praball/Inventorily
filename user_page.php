         ...
         <!-- It's likely you'll need to link the card somewhere. You could add a button in the info, link the titles, or even wrap the entire card in an <a href="..."> -->
            ...
            <div class="product-card">
               <div class="product-image">
                  <img src="default.jpg" width="200px">
               </div>
               <div class="product-info">
                  <form action="product.php" method="get">
                  <h5><input type="text" readonly name="name" value="<?php echo $rows['itemname']; ?>"></h5>
                  <h6><input type="text" name="price" value="<?php echo $rows['price']; ?>" readonly></h6>
                  <input type="hidden" name="quantity" value="<?php echo $rows['itemnumber'];?>">
                  <input type="submit" name="submit" value="Here" class="form-btn" style="border-radius: 4px; border-color: white;">
                  </form>
               </div>
            </div>
