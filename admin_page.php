...
if (isset($_POST['submit'])) {
   ...
   $insert = "INSERT INTO supplier_form(suppliername, itemname, itemnumber, price) VALUES('$suppliername','$itemname','$itemnumber','$price')";
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
               <a class="nav-link" href="user_page.php">View Order History<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
               <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"><?php echo $_SESSION['admin_name'] ?></a>
            </li>
         </ul>
         <a href="logout.php"  button type="button" class="btn btn-dark">logout</a>
   ...
   <div style="text-align:center;">
      <h2>Want to enlist new items?</h2>
   </div><br>
   ...
   <form action="" method="post" onsubmit="myFunction()">
      ...
      <div class="form-group" style="margin-left: 400px; margin-right: 400px;">
         ...
         <input type="number" class="form-control" name="price" id="itemprice" placeholder="Price in Rs.">
      </div>
<br>
